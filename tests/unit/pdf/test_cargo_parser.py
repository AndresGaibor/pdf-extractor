...
Solo casos no ambiguos (donde la convención de cargo es clara).
Casos ambiguos (adscripción territorial con categoría base vs función)
quedan fuera hasta decisión funcional.
"""
